...
### Fixed
- Re-ordered resolution of marker textures so that Antique Atlas markers are preferred to stack textures if both are 
  present. This fixes stack icons appearing instead of AA4 markers with Antique Atlas 4 3.1.0

## [1.6.2] 2025-12-30

### Changed
- Updated to Surveyor 1.1.0

## [1.6.1] 2025-12-30

### Fixed
- Reset shader color properly after drawing compass directions.
